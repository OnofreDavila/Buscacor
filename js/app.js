...
document.addEventListener('DOMContentLoaded', () => {
    mostrarAutos(autos); //muestra los autos al cargar en el DIV de resultados
...
function mostrarAutos(autos) {
    ...
    autos.forEach( auto => {
        const {marca, modelo, year, puertas, transmision, precio, color} = auto; //destruction a la selecion de auto del arreglo autos
...
function llenarSelect(){
    for(i=max; i>=min; i--){
        ...
        year.appendChild(opcion);//agregar las opciones de año al selecttor de años
    };
}
